...
import { validatePhone, validatePhoneOptional, formatPhoneInput } from "@/utils/validation";
...
export default function PhoneInput({
    ...
    useEffect(() => {
        if (touched || value) {
            const validation = required ? validatePhone(value) : validatePhoneOptional(value);
