        ...
        <div className="min-h-screen bg-gray-50 pb-20">
            ...
            <div className="bg-white shadow-sm">
                <div className="h-48 bg-gradient-to-r from-pink-400 to-purple-500 relative">
                    <Link href="/customer" className="absolute top-6 left-6 text-white hover:bg-white/20 p-2 rounded-full transition-colors">
                        <ArrowLeft size={24} />
                    </Link>
                            ...
                            <div className="grid sm:grid-cols-2 gap-4">
                                {products.map(product => (
                                    <div key={product.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow flex flex-col">
                                        <Link href={`/customer/product/${product.id}`} className="h-48 bg-gray-100 relative block group">
                                            {product.image ? (
                                        ...
                                        <div className="p-4 flex flex-col flex-1">
                                            <div className="flex justify-between items-start mb-1">
                                                <Link href={`/customer/product/${product.id}`} className="font-bold text-gray-900 hover:text-pink-600 transition-colors line-clamp-1">
                                                    {product.name}
                                                </Link>
                                            ...
                                            {product.variants && product.variants.length > 0 && (
                                                <div className="mt-auto pt-3 border-t border-gray-50 mb-3">
                                            ...
                                            <button
                                                ...
                                                className="w-full mt-auto py-2 bg-pink-50 text-pink-600 border border-pink-200 rounded-lg text-sm font-bold hover:bg-pink-100 transition-colors flex items-center justify-center gap-2"
                                            >
                                                <ShoppingBag size={16} />
                                                Add to Cart
                                            </button>
